...
In terms of the overall look of the plot, `ggplot2` includes a number of built-in themes. Let's take a look at all of them here.^[For more themes, see the section in this document where I reference the `ggthemes` package. To be really cool, see the section that follows on creating your own theme.]
